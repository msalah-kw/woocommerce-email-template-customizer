...
$img_style           = ! empty( $props['childStyle']['.viwec-product-img'] ) ? $render->parse_styles( $props['childStyle']['.viwec-product-img'] ) : '';
...
$parent_width = ! empty( $props['style']['width'] ) ? (float) $props['style']['width'] : 600;
    ...
    <table width='100%' border='0' cellpadding='0' cellspacing='0' align='center' valign="middle" style='<?php echo esc_attr( $tmp_item_style ) ?>'>
        <tr>
			...
			if ( $img_width && ! empty( $img_url ) ) {
				?>
                <td valign='middle' class="viwec-responsive viwec-product-responsive"
                    style="display:inline-block;width:<?php echo esc_attr( $img_width ) ?>px;<?php echo $img_style; ?>">
			...
			?>
            <td valign='middle' class="viwec-responsive" style="display:inline-block;width:<?php echo esc_attr( $name_width ) ?>px;">
                <table border="0" cellpadding="0" cellspacing="0" valign="middle"
                    ...
                    <tr>
                        ...
                        <td valign="middle" class="viwec-responsive-center">
                            ...
                            <?php
                            if (!$price_size || !strpos($price_size,'font-size:0px')){
	                            ?>
							...
							do_action( 'viwec_after_item_price', $item, $order );
